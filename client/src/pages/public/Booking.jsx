            ...
            <div>
              ...
              <div className="mt-3 flex w-fit items-center border border-border">
                ...
                <button
                  ...
                  className="num px-3 py-2 text-xs transition-colors hover:bg-sumi hover:text-washi disabled:cursor-not-allowed disabled:opacity-30"
                >
                  −
                </button>
