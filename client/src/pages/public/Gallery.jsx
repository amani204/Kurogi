  ...
  if (loading) {
    return (
      <main className="pt-24 md:pt-32">
        <div className="shell py-32 text-center text-sumi/40">{t("galleryPage.loading")}</div>
      </main>
    );
  }
  if (error) {
    return (
      <main className="pt-24 md:pt-32">
        <div className="shell py-32 text-center text-sumi/40">{t("galleryPage.error")}</div>
      </main>
    );
  }
  ...
  return (
    <main className="pt-24 md:pt-32">
      <header className="shell">
        <p className="label text-shu">{t("galleryPage.eyebrow")}</p>
